        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_300px]">
          ...
          <aside className="h-fit space-y-4">
            <div className="rounded-2xl border border-black/8 bg-[#f8fafa] p-5">
              ...
              <a href="https://wa.me/573125860921" target="_blank" rel="noreferrer"
                className="mt-4 flex w-full items-center justify-center gap-2 rounded-full bg-[#0C535B] px-4 py-2.5 text-sm font-bold text-white hover:opacity-90 transition-opacity">
