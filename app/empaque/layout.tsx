      ...
      <aside className="flex w-56 shrink-0 flex-col border-r border-[#E2E8F0] bg-white" style={{ minHeight: "100vh", position: "sticky", top: 0, height: "100vh" }}>
        ...
        <div className="border-t border-[#E2E8F0] p-3 space-y-2">
          ...
          <button
            onClick={logout}
            disabled={loggingOut}
            className="flex w-full items-center gap-2 rounded-xl border border-red-100 bg-red-50 px-3 py-2 text-xs font-semibold text-red-500 transition-colors hover:bg-red-100 disabled:opacity-60"
          >
